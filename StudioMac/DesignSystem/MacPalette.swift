...
///
/// The **brand accent is skin-driven** (`Skin.current`, default 深大红) — it replaced the former
...
enum MacPalette {
    /// Brand accent from the active `Skin` (default 深大红). Was Apple green #34C759/#30D158.
