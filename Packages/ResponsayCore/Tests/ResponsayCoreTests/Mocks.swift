...
final class MockSpeechCaptureService: SpeechCaptureService {
    ...
    func stop() async throws -> String { transcriptToReturn }
}
...
struct MockCoachAPI: CoachAPI {
    ...
    var analysis: ProsodyAnalysis?
    var error: CoachAPIError?
    var analyzeError: CoachAPIError?
    ...
    func analyze(_ sentence: String) async throws -> ProsodyAnalysis {
        ...
        return analysis ?? ProsodyAnalysis(text: sentence, isGeneratedExample: false, sourceWord: nil,
