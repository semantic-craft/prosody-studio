...
public enum TTSProviderCatalogPresets {
    public static let all: [TTSProviderCatalog] = [doubao, qwen, mimo, minimax, gemini, openai]

    public static func catalog(for providerID: TTSProviderID) -> TTSProviderCatalog? {
        all.first { $0.providerID == providerID }
    }

    // MARK: - 火山云 (Doubao / Volcengine) — ultra-low latency bi-directional TTS
    
    public static let doubao = TTSProviderCatalog(
        providerID: "doubao",
        displayName: "火山云",
        models: [
            TTSModelSpec(id: DoubaoTTSCredentials.defaultResourceID, displayName: DoubaoTTSCredentials.defaultResourceID,
                         supportsStreaming: true, supportsRealtimeWS: true),
        ],
        voices: [
            TTSVoiceSpec(id: "en_female_dacey_uranus_bigtts",
                         displayName: "Dacey (女·美式英语)",
                         supportedModelIDs: [DoubaoTTSCredentials.defaultResourceID],
                         languageHints: ["en-US"], genderHint: "female"),
            TTSVoiceSpec(id: "en_male_tim_uranus_bigtts",
                         displayName: "Tim (男·美式英语)",
                         supportedModelIDs: [DoubaoTTSCredentials.defaultResourceID],
                         languageHints: ["en-US"], genderHint: "male"),
            TTSVoiceSpec(id: "en_female_stokie_uranus_bigtts",
                         displayName: "Stokie (女·美式英语)",
                         supportedModelIDs: [DoubaoTTSCredentials.defaultResourceID],
                         languageHints: ["en-US"], genderHint: "female"),
            TTSVoiceSpec(id: "zh_female_vv_uranus_bigtts",
                         displayName: "Vivi 2.0 (女·中文)",
                         supportedModelIDs: [DoubaoTTSCredentials.defaultResourceID],
                         languageHints: ["zh"], genderHint: "female"),
            TTSVoiceSpec(id: "zh_female_xiaohe_uranus_bigtts",
                         displayName: "小何 2.0 (女·中文)",
                         supportedModelIDs: [DoubaoTTSCredentials.defaultResourceID],
                         languageHints: ["zh"], genderHint: "female"),
            TTSVoiceSpec(id: "zh_male_m191_uranus_bigtts",
                         displayName: "云舟 2.0 (男·中文)",
                         supportedModelIDs: [DoubaoTTSCredentials.defaultResourceID],
                         languageHints: ["zh"], genderHint: "male")
        ],
        defaults: TTSDefaults(modelID: DoubaoTTSCredentials.defaultResourceID,
                              voiceID: "en_female_dacey_uranus_bigtts",
    ...
    public static let qwen = TTSProviderCatalog(
        ...
        displayName: "阿里云百炼",
        models: [
            TTSModelSpec(id: "qwen3-tts-flash-realtime", displayName: "qwen3-tts-flash-realtime",
                         supportsStreaming: true, supportsRealtimeWS: true),
            TTSModelSpec(id: "qwen3-tts-instruct-flash-realtime",
                         displayName: "qwen3-tts-instruct-flash-realtime",
                         supportsStreaming: true, supportsRealtimeWS: true),
            TTSModelSpec(id: "qwen3-tts-flash", displayName: "qwen3-tts-flash", supportsStreaming: true),
            TTSModelSpec(id: "qwen3-tts-instruct-flash", displayName: "qwen3-tts-instruct-flash",
                         supportsStreaming: true),
        ],
        voices: [
            TTSVoiceSpec(id: "Cherry", displayName: "Cherry / 芊悦 (女·亲切)", languageHints: ["zh", "en", "de"], genderHint: "female"),
            TTSVoiceSpec(id: "Serena", displayName: "Serena / 苏瑶 (女·温柔)", languageHints: ["zh", "en", "de"], genderHint: "female"),
            TTSVoiceSpec(id: "Ethan", displayName: "Ethan / 晨煦 (男·清亮)", languageHints: ["zh", "en", "de"], genderHint: "male"),
            TTSVoiceSpec(id: "Maia", displayName: "Maia / 四月 (女·知性)", languageHints: ["zh", "en", "de"], genderHint: "female"),
            TTSVoiceSpec(id: "Kai", displayName: "Kai / 凯 (男·松弛)", languageHints: ["zh", "en", "de"], genderHint: "male"),
            TTSVoiceSpec(id: "Jennifer", displayName: "Jennifer / 詹妮弗 (女·美式英语)", languageHints: ["en-US", "zh", "de"], genderHint: "female"),
            TTSVoiceSpec(id: "Ryan", displayName: "Ryan / 甜茶 (男·戏感)", languageHints: ["en", "zh", "de"], genderHint: "male"),
            TTSVoiceSpec(id: "Neil", displayName: "Neil / 阿闻 (男·新闻)", languageHints: ["zh", "en", "de"], genderHint: "male"),
            TTSVoiceSpec(id: "Ono Anna", displayName: "Ono Anna / 小野杏 (女·日语)", languageHints: ["ja", "zh", "en"], genderHint: "female"),
            TTSVoiceSpec(id: "Lenn", displayName: "Lenn / 莱恩 (男·德语)", languageHints: ["de", "zh", "en"], genderHint: "male"),
            TTSVoiceSpec(id: "Emilien", displayName: "Emilien / 埃米尔安 (男·法语)", languageHints: ["fr", "zh", "en"], genderHint: "male"),
            TTSVoiceSpec(id: "Alek", displayName: "Alek / 阿列克 (男·俄语)", languageHints: ["ru", "zh", "en"], genderHint: "male"),
            TTSVoiceSpec(id: "Dolce", displayName: "Dolce / 多尔切 (男·意语)", languageHints: ["it", "zh", "en"], genderHint: "male"),
            TTSVoiceSpec(id: "Sohee", displayName: "Sohee / 素熙 (女·韩语)", languageHints: ["ko", "zh", "en"], genderHint: "female"),
            TTSVoiceSpec(id: "Jada", displayName: "Jada / 上海-阿珍 (女·方言)", languageHints: ["zh"], genderHint: "female", styleTags: ["dialect"]),
            TTSVoiceSpec(id: "Dylan", displayName: "Dylan / 北京-晓东 (男·方言)", languageHints: ["zh"], genderHint: "male", styleTags: ["dialect"]),
            TTSVoiceSpec(id: "Roy", displayName: "Roy / 闽南-阿杰 (男·方言)", languageHints: ["zh"], genderHint: "male", styleTags: ["dialect"]),
            TTSVoiceSpec(id: "Peter", displayName: "Peter / 天津-李彼得 (男·方言)", languageHints: ["zh"], genderHint: "male", styleTags: ["dialect"]),
            TTSVoiceSpec(id: "Sunny", displayName: "Sunny / 四川-晴儿 (女·方言)", languageHints: ["zh"], genderHint: "female", styleTags: ["dialect"]),
            TTSVoiceSpec(id: "Eric", displayName: "Eric / 四川-程川 (男·方言)", languageHints: ["zh"], genderHint: "male", styleTags: ["dialect"]),
            TTSVoiceSpec(id: "Rocky", displayName: "Rocky / 粤语-阿强 (男·方言)", languageHints: ["zh"], genderHint: "male", styleTags: ["dialect"]),
            TTSVoiceSpec(id: "Kiki", displayName: "Kiki / 粤语-阿清 (女·方言)", languageHints: ["zh"], genderHint: "female", styleTags: ["dialect"]),
        ],
        defaults: TTSDefaults(modelID: "qwen3-tts-flash-realtime",
                              voiceID: "Cherry",
                              sampleRate: TTSAudio.defaultSampleRate))
    ...
    public static let gemini = TTSProviderCatalog(
        ...
        models: [
            ...
            TTSModelSpec(id: "gemini-3.1-pro-tts-preview", displayName: "gemini-3.1-pro-tts-preview"),
        ],
        voices: [
