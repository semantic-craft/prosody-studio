...
///
/// Wire values mirror the backend `coachRegisterDirective` (issue 178); the default is `.casual`
/// (口语), which preserves the Coach's original behavior. See `CONTEXT.md` (教练语域 / CoachRegister)
/// and the PRD `docs/specs/2026-06-08-coach-register-tiers-prd.md`.
