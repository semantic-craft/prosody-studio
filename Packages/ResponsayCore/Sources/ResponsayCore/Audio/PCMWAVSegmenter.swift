...
public enum PCMWAVSegmenter {
    ...
    /// GLM ASR caps *duration* at 30 s per request (glm_asr.md), not just bytes:
    /// 28 s × 16 kHz × 2 B = 896 KB per segment, with a 2 s safety margin.
    public static let glmMaxSegmentBytes = 896_000
